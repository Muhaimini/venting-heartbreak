...
hoistedDependencies:
  ...
  /create-jest/29.7.0_@types+node@22.8.1:
    create-jest: private
  /cross-spawn/7.0.3:
    cross-spawn: private
  /debug/4.3.7:
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0_@types+node@22.8.1:
    jest-cli: private
  /jest-config/29.7.0_@types+node@22.8.1:
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 28 Oct 2024 06:49:46 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/a2017/Library/pnpm/store/v3
